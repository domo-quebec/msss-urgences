...
**Note : Le code ci-dessous donne un aperçu, utilisez le code directement dans le fichier [configuration.yaml](configuration.yaml) pour un plus large éventail d'exemple.**
